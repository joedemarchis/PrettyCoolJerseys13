...
function JerseyCard({ jersey }: { jersey: Jersey }) {
  ...
  return (
    ...
    >
      <div className="relative w-full aspect-square bg-vault-surface outline-1 -outline-offset-1 outline-vault-text/5 rounded-[min(1vw,12px)] overflow-hidden p-6 sm:p-8">
        <img
